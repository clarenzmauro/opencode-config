...
- Keep talk very short. Explain using simple words. Think XKCD's "Thing Explainer" style - no jargon unless needed. Don't use many words when a few simple ones will do
